...
export class Open implements CommandInterface {
  readonly uniqueKey: string = "drag-image-open"
  readonly title: string = "command_drag_image_open_title"
  readonly description: string = "command_drag_image_open_description"
